...
const myAppArticle = () => {
  <article className="article">
    ...
    <p className="article__paragraph">
      ...
      fermentumac·quam.·Aliquam·pretium·tristique·nibh·quis·iaculis.·In·et·
      cursus·ex,
      ·eualiquet·ex.·Proin·facilisis·lacus·sit·amet·sapien·ultrices,·ut·vehicula
    ...
    <p className="article__paragraph">
      ...
      tristique·vehicula.·Ut·ligula·tortor,·tincidunt·quis·sodales·vitae,·orna
    </p>
  </article>;
};

export default myAppArticle;
